...
public static class Mapping
{
    public static void Configure()
    {
        ...
        // Product to CreateProductResponse configuration
        TypeAdapterConfig<Product, CreateProductResponse>.NewConfig()
            ...
            .Map(dest => dest.MinDeleveryDays, src => src.MinDeleveryDays)
            .Map(dest => dest.MaxDeleveryDays, src => src.MaxDeleveryDays)
            .Map(dest => dest.MainImageUrl, src => src.MainImageUrl)
            .Map(dest => dest.Variants, src =>
                src.Variants.Select(v => v.Adapt<VariantResponse>()).ToList());

        // Variant to VariantResponse configuration
