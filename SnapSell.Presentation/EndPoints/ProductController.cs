...
public sealed class ProductController(ISender sender) : ApiControllerBase
{
    ...
    public async Task<ActionResult<Result<List<GetAllBrandsResponse>>>> GetAllBrands(
    ...
    public async Task<ActionResult<Result<List<GetAllCategoriesGroupedResponse>>>> GetAllCategories(
        CancellationToken cancellationToken)
    {
    ...
    [HttpGet("GetAllSizes")]
    public async Task<ActionResult<Result<IReadOnlyList<GetAllSizesGroupedResponse>>>> GetAllSizes(
        CancellationToken cancellationToken)
    {
